...
constexpr uint8_t L_DRIVE_PWM_PIN = D8;
constexpr uint8_t L_DRIVE_DIR_PIN = D7;

constexpr uint8_t R_DRIVE_PWM_PIN = D6;
constexpr uint8_t R_DRIVE_DIR_PIN = D5;

constexpr uint8_t TL_LEG_PWM_PIN = D12;
constexpr uint8_t TL_LEG_DIR_PIN = D11;

constexpr uint8_t TR_LEG_PWM_PIN = D10;
constexpr uint8_t TR_LEG_DIR_PIN = D9;

constexpr uint8_t BL_LEG_PWM_PIN = A3;
constexpr uint8_t BL_LEG_DIR_PIN = A2;

constexpr uint8_t BR_LEG_PWM_PIN = A1;
constexpr uint8_t BR_LEG_DIR_PIN = A0;
